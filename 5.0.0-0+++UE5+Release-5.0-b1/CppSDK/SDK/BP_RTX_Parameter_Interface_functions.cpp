...
void IBP_RTX_Parameter_Interface_C::Enable_DLSS_RR(bool Enable_DLSSD)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_RTX_Parameter_Interface_C", "Enable_DLSS_RR");
...
void IBP_RTX_Parameter_Interface_C::RTX_Force_Override()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_RTX_Parameter_Interface_C", "RTX_Force_Override");
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FString&                    AA_Method                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// const class FString&                    DLSS_Quality                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void IBP_RTX_Parameter_Interface_C::RTX_Switch_DLSS_From_UI(const class FString& AA_Method, const class FString& DLSS_Quality, bool Enable_Override_From_UI)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_RTX_Parameter_Interface_C", "RTX_Switch_DLSS_From_UI");
...
void IBP_RTX_Parameter_Interface_C::RTX_Switch_Preset_From_UI(Enum_RT_Quality_Preset RTX_Preset)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_RTX_Parameter_Interface_C", "RTX_Switch_Preset_From_UI");
