...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    ContentString                                          (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TArray<class FString>&            FilePaths                                              (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
// const class FString&                    Boundary                                               (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    HeaderName                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    HeaderValue                                            (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
