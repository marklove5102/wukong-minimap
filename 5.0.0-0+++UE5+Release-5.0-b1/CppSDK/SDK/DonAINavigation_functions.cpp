...
// const struct FDoNNavigationQueryParams& QueryParams                                            (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// const struct FDoNNavigationDebugParams& DebugParams                                            (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// TDelegate<void(const struct FDoNNavigationQueryData& Data)>ResultHandlerDelegate                                  (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// TDelegate<void(const struct FDonNavigationDynamicCollisionPayload& Data)>DynamicCollisionListener                               (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// TDelegate<void(const struct FDonNavigationDynamicCollisionPayload& Data)>ListenerToClear                                        (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// const struct FDoNNavigationQueryData&   QueryData                                              (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TDelegate<void(const struct FDonNavigationDynamicCollisionPayload& Data)>Listener                                               (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// struct FDoNNavigationQueryData*         QueryData                                              (Parm, OutParm, ContainsInstancedReference, NativeAccessSpecifierPublic)

void ADonNavigationManager::VisualizeDynamicCollisionListeners(TDelegate<void(const struct FDonNavigationDynamicCollisionPayload& Data)> Listener, struct FDoNNavigationQueryData* QueryData)
{
	static class UFunction* Func = nullptr;
