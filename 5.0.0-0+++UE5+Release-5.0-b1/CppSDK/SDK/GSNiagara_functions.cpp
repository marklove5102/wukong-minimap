...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const struct FGSNiagaraParticleInfo&    Info                                                   (Parm, NoDestructor, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TArray<struct FVector>&           TargetPosArray                                         (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TArray<float>&                    TargetSizeArray                                        (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TArray<struct FGSNiagaraParticleInfo>&InParticleInfoArray                                    (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
