...
// (BlueprintCosmetic, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const class UPlayerMappableInputConfig* Config                                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FModifyContextOptions&     Options                                                (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
int32 IEnhancedInputSubsystemInterface::AddPlayerMappedKey(const class FName MappingName, const struct FKey& NewKey, const struct FModifyContextOptions& Options)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "AddPlayerMappedKey");
...
int32 IEnhancedInputSubsystemInterface::RemovePlayerMappedKey(const class FName MappingName, const struct FModifyContextOptions& Options)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("EnhancedInputSubsystemInterface", "RemovePlayerMappedKey");
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const class UInputAction*               InAction                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
