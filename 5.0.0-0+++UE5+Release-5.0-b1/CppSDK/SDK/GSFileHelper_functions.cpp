...
int64 UGSFileHelper::FileSize(const class FString& Filename, bool IsStandardPath)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const class FString&                    Filename                                               (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const TArray<uint8>&                    BytesToWrite                                           (Parm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// TArray<struct FAssetInfo>*              OutAssetInfos                                          (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
bool UGSAssetHelper::GetAssetsByPath(const class FString& PackagePath, TArray<struct FAssetInfo>* OutAssetInfos, bool bRecursive, bool bIncludeOnlyOnDiskAssets)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GSAssetHelper", "GetAssetsByPath");

	Params::GSAssetHelper_GetAssetsByPath Parms{};
	...
	if (OutAssetInfos != nullptr)
		*OutAssetInfos = std::move(Parms.OutAssetInfos);
...
bool UGSAssetHelper::HasAsset(const class FString& ObjectPath, bool bIncludeOnlyOnDiskAssets)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GSAssetHelper", "HasAsset");

	Params::GSAssetHelper_HasAsset Parms{};
