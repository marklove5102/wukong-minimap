...
public:
	...
	{
		STATIC_CLASS_IMPL("ArteriesLibrary")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ArteriesLibrary")
	}
...
DUMPER7_ASSERTS_UArteriesLibrary;
...
{
public:
	TMulticastInlineDelegate<void(class UArteriesObject* Object, const struct FTransform& Transform)> OnBuildCompleted; // 0x0288(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UArteriesObject*                        FinalObject;                                       // 0x0298(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ArteriesActor")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ArteriesActor")
	}
...
DUMPER7_ASSERTS_AArteriesActor;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ArteriesSettings")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ArteriesSettings")
	}
...
DUMPER7_ASSERTS_UArteriesSettings;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ArteriesObject")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ArteriesObject")
	}
...
DUMPER7_ASSERTS_UArteriesObject;
