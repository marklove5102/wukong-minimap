...
// const struct FCLSMaterialParametersCollectionProperty&InTargetCLSVolumeMPCProperty                           (Parm, NativeAccessSpecifierPublic)
// const struct FCLSMaterialParametersCollectionProperty&InOriginalCLSVolumeMPCProperty                         (Parm, NativeAccessSpecifierPublic)
...
uint8 IRTXSettings::GetRTXQuality()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "GetRTXQuality");
...
bool IRTXSettings::IsDLSSRREnabled()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "IsDLSSRREnabled");
...
bool IRTXSettings::IsRTXEnabled()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "IsRTXEnabled");
...
void IRTXSettings::SetDlssRREnable(bool bEnable)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "SetDlssRREnable");
...
void IRTXSettings::SetRTXEnabled(bool bInEnable)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "SetRTXEnabled");
...
void IRTXSettings::SetRTXQuality(uint8 Quality)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("RTXSettings", "SetRTXQuality");
...
// (Final, Native, Public, Const)
// Parameters:
// const class FString&                    TargetParameter                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
